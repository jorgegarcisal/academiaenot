(function () {
  ...
  var translations = {
    gl: {
      'meta.title': 'Academia Enot - Clases de Apoio en Pontevedra',
      'meta.description': 'Academia de apoio escolar en Pontevedra. Clases de Primaria, ESO, Bacharelato, Facultades e máis',
      'nav.home': 'Inicio',
    ...
    es: {
      'meta.title': 'Academia Enot - Clases de Apoyo en Pontevedra',
      'meta.description': 'Academia de apoyo escolar en Pontevedra. Clases de Primaria, ESO, Bachillerato, Facultades y más',
      'nav.home': 'Inicio',
