(function () {
  ...
  var translations = {
    gl: {
      ...
      'hero.title': 'Clases de apoio e particulares en Pontevedra',
      'hero.subtitle': 'Levamos anos axudando aos estudantes a acadar os seus obxectivos académicos en Primaria, ESO, Bacharelato e máis',
    ...
    es: {
      ...
      'nav.levels': 'Niveles',
      'nav.contact': 'Contacto',
      'hero.title': 'Clases de apoyo y particulares en Pontevedra',
      'hero.subtitle': 'Llevamos años ayudando a estudiantes a alcanzar sus objetivos académicos en Primaria, ESO, Bachillerato y más',
      'hero.cta': 'Contáctanos',
